...
check_client_navigation_case( 'primary client menu contains Reviews and Support', str_contains( $client_menu, "'widgets' => 'Reviews & Widgets'" ) && str_contains( $client_menu, "'support' => 'Support'" ) );
check_client_navigation_case( 'operator pages are absent from the primary client menu', ! preg_match( '/connections|seo-pages|links|logs|help|Reference|Activity Log|Settings/', $client_menu ) );
