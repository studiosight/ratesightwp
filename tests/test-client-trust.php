...
check_client_trust_case( 'client status surfaces use proven connection helper instead of legacy ID presence', str_contains( $wizard, 'Ratesight_Pairing::is_connected()' ) && str_contains( $support, 'Ratesight_Pairing::is_connected()' ) && str_contains( $connections, 'Ratesight_Pairing::is_connected()' ) && ! str_contains( $support, "Ratesight_Options::get( 'code_id' )" ) );
