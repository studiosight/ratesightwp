...
check_client_safety_case( 'missing performance setup gives calm honest guidance', str_contains( $performance, 'Performance reporting is being prepared. No action is needed here.' ) && ! str_contains( $performance, 'Add the Ratesight ID on the Connections tab' ) );
