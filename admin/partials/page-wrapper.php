...
/* Header */
.rs-header { background:#1d2327!important; display:flex!important; align-items:center!important; padding:16px 22px!important; border-radius:4px 4px 0 0!important; margin-bottom:0!important; }
...
<div class="wrap rs-page">
	...
	<div class="rs-body">
		...
		$partial = __DIR__ . '/' . ( $map[ $tab ] ?? 'tab-performance.php' );
