...
class Ratesight_Webhook_Handler {
	...
	public function handle_capabilities( \WP_REST_Request $request ): \WP_REST_Response {
		...
		return new \WP_REST_Response( array(
			...
			'auth'                 => Ratesight_Request_Auth::capability_auth(),
			'pairing'              => Ratesight_Pairing::status(),
			'plugin_update'        => array( 'contract' => Ratesight_Release_Update::CONTRACT, 'preflight' => true, 'apply' => true ),
			'create_page'          => true,
			'set_redirect'         => true,
			...
			'provider_ownership'   => array(
				'gbp_auto_post'   => false, // Retired in 3.12.2: the dashboard owns blog to GBP posts.
