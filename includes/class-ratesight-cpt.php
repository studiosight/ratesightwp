	...
	public static function do_register() {
		...
		register_post_type( 'ratesight_page', array(
			'labels' => array(
				...
				'add_new'            => 'Add New SEO Page',
				'add_new_item'       => 'Add New SEO Page',
				'edit_item'          => 'Edit SEO Page',
				'new_item'           => 'New SEO Page',
				'view_item'          => 'View SEO Page',
				'view_items'         => 'View SEO Content',
				'search_items'       => 'Search SEO Content',
				'not_found'          => 'No SEO content found.',
				'not_found_in_trash' => 'No SEO content found in Trash.',
				'all_items'          => 'All SEO Content',
		...
		register_taxonomy( 'rs_category', 'ratesight_page', array(
			...
			'labels'            => array(
				...
				'add_new_item'  => 'Add New SEO Category',
				'edit_item'     => 'Edit SEO Category',
				'search_items'  => 'Search SEO Categories',
				'all_items'     => 'All SEO Categories',
			),
			'hierarchical'      => true,
			'public'            => true,
			'show_ui'           => true,
