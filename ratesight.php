...
define( 'RATESIGHT_RELEASE_VERSION', '3.10.3' );
...
foreach ( array(
	...
	'includes/class-ratesight-connection-ownership.php',
	...
	'includes/class-ratesight-squirrly.php',
	...
	'includes/class-ratesight-page-api.php',
	'includes/class-ratesight-media-alt.php',
